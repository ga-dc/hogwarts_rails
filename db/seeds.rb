...
#  #GIRO: Student WAS MISSPELLED "student"
#  #GIRO: CHANGED FROM image_url to img_url
#  #GIRO: CHANGED FROM Houses.destroy_all  to House.destroy_al
...
Student.destroy_all   #GIRO: WAS MISSPELLED "student"
House.destroy_all
